...
function ale_get_options() {
    ...
    $options[] = array( "name" => esc_html__("Select the First Font from Google Library","gardener"),
                        "desc" => esc_html__("The default Font is - Lato","gardener"),
                        "id" => "ale_font_one",
                        "std" => "lato",
                        "type" => "select",
                        "options" => $headerfont);
    ...
    $options[] = array( "name" => esc_html__("Select the Second Font from Google Library","gardener"),
                        "desc" => esc_html__("The default Font is - Playfair Display","gardener"),
                        "id" => "ale_font_two",
    ...
    $options[] = array( 'name' => esc_html__("H1 Style","gardener"),
                        ...
                        'id' => 'ale_h1sty',
                        'std' => array('size' => '32px','face' => 'playfair-Display','style' => 'normal','transform'=>'none', 'weight'=>'700','lineheight'=>'normal','color' => '#000000'),
                        'type' => 'typography');

    $options[] = array( 'name' => esc_html__("H2 Style","gardener"),
                        'desc' => esc_html__("Change the h2 style","gardener"),
                        'id' => 'ale_h2sty',
                        'std' => array('size' => '28px','face' => 'playfair-Display','style' => 'normal','transform'=>'none', 'weight'=>'700','lineheight'=>'normal','color' => '#000000'),
                        'type' => 'typography');

    $options[] = array( 'name' => esc_html__("H3 Style","gardener"),
                        'desc' => esc_html__("Change the h3 style","gardener"),
                        'id' => 'ale_h3sty',
                        'std' => array('size' => '24px','face' => 'playfair-Display','style' => 'normal','transform'=>'none', 'weight'=>'700','lineheight'=>'normal','color' => '#000000'),
                        'type' => 'typography');

    $options[] = array( 'name' => esc_html__("H4 Style","gardener"),
                        'desc' => esc_html__("Change the h4 style","gardener"),
                        'id' => 'ale_h4sty',
                        'std' => array('size' => '20px','face' => 'playfair-Display','style' => 'normal','transform'=>'none', 'weight'=>'700','lineheight'=>'normal','color' => '#000000'),
                        'type' => 'typography');

    $options[] = array( 'name' => esc_html__("H5 Style","gardener"),
                        'desc' => esc_html__("Change the h5 style","gardener"),
                        'id' => 'ale_h5sty',
                        'std' => array('size' => '16px','face' => 'playfair-Display','style' => 'normal','transform'=>'none', 'weight'=>'700','lineheight'=>'normal','color' => '#000000'),
                        'type' => 'typography');

    $options[] = array( 'name' => esc_html__("H6 Style","gardener"),
                        'desc' => esc_html__("Change the h6 style","gardener"),
                        'id' => 'ale_h6sty',
                        'std' => array('size' => '14px','face' => 'playfair-Display','style' => 'normal','transform'=>'none', 'weight'=>'700','lineheight'=>'normal','color' => '#000000'),
                        'type' => 'typography');

    $options[] = array( 'name' => esc_html__("Body Style","gardener"),
                        'desc' => esc_html__("Change the body font style","gardener"),
                        'id' => 'ale_bodystyle',
                        'std' => array('size' => '14px','face' => 'lato','style' => 'normal','transform'=>'none', 'weight'=>'400','lineheight'=>'24px','color' => '#434343'),
                        'type' => 'typography');
...
function ale_metaboxes($meta_boxes) {
    ...
    $meta_boxes[] = array(
        'id'         => 'home1_settings_metabox',
        'title'      => esc_html__('О себе','gardener'),
        ...
        'fields' => array(
            ...
            array(
                'name' => esc_html__('Заголовок блока','gardener'),
                'desc' => esc_html__('Введи заголовок блока','gardener'),
                'id'   => $prefix . 'box_title',
                'std'  => '',
                'type'    => 'text',
            ),
            array(
                'name' => esc_html__('Описание блока','gardener'),
                'desc' => esc_html__('Введи описание блока','gardener'),
                'id'   => $prefix . 'box_description',
                'std'  => '',
                'type'    => 'text',
            ),
            array(
                'name' => esc_html__('Фото','gardener'),
                'desc' => esc_html__('Загрузи свою фотографию','gardener'),
                'id'   => $prefix . 'box_image',
                'std'  => '',
                'type'    => 'file',
            ),
    ...
    $meta_boxes[] = array(
        'id'         => 'home2_settings_metabox',
        'title'      => esc_html__('Достижения','gardener'),
        'pages'      => array( 'page', ), // Post type
        'context'    => 'normal',
        'priority'   => 'high',
        'show_on'    => array( 'key' => 'page-template', 'value' => array('template-homepage.php'), ), // Specific post templates to display this metabox
        ...
        'fields' => array(
            ...
            array(
                'name' => esc_html__('Достижение 1','gardener'),
                'desc' => esc_html__('Введи достижение','gardener'),
                'id'   => $prefix . 'achievement1',
                'std'  => '',
                'type'    => 'text',
            ),
            array(
                'name' => esc_html__('Достижение 2','gardener'),
                'desc' => esc_html__('Введи достижение','gardener'),
                'id'   => $prefix . 'achievement2',
                'std'  => '',
                'type'    => 'text',
            ),
            array(
                'name' => esc_html__('Достижение 3','gardener'),
                'desc' => esc_html__('Введи достижение','gardener'),
                'id'   => $prefix . 'achievement3',
                'std'  => '',
                'type'    => 'text',
            ),
            array(
                'name' => esc_html__('Достижение 4','gardener'),
                'desc' => esc_html__('Введи достижение','gardener'),
                'id'   => $prefix . 'achievement4',
                'std'  => '',
                'type'    => 'text',
            ),
            array(
                'name' => esc_html__('Достижение 5','gardener'),
                'desc' => esc_html__('Введи достижение','gardener'),
                'id'   => $prefix . 'achievement5',
                'std'  => '',
                'type'    => 'text',
            ),
            array(
                'name' => esc_html__('Достижение 6','gardener'),
                'desc' => esc_html__('Введи достижение','gardener'),
                'id'   => $prefix . 'achievement6',
                'std'  => '',
                'type'    => 'text',
            ),            
        )
    ...
    $meta_boxes[] = array(
        ...
        'fields' => array(
            ...
            array(
                'name' => esc_html__('Заголовок страницы','gardener'),
            ...
            array(
                'name' => esc_html__('Фото #1','gardener'),
            ...
            array(
                'name' => esc_html__('Фото #2','gardener'),
            ...
            array(
                'name' => esc_html__('Информация на 1 странице','gardener'),
                'desc' => esc_html__('Type here the description.','gardener'),
                'id'   => $prefix . 'info_description_one',
                'std'  => '',
                'type'    => 'textarea',
            ),
            array(
                'name' => esc_html__('Информация на 2 странице','gardener'),
                'desc' => esc_html__('Type here the description.','gardener'),
                'id'   => $prefix . 'info_description_two',
                'std'  => '',
                'type'    => 'textarea',
            ),
        )
    ...
    $meta_boxes[] = array(
        'id'         => 'works_metabox',
        'title'      => esc_html__('Works Options','gardener'),
        ...
        'fields' => array(
            ...
            array(
                'name' => esc_html__('Works Subtitle','gardener'),
                'desc' => esc_html__('Type here the subtitle','gardener'),
                'id'   => $prefix . 'works_subtitle',
                'std'  => '',
                'type'    => 'text',
            ),
            array(
                'name' => esc_html__('Works link','gardener'),
                'desc' => esc_html__('Type here the link','gardener'),
                'id'   => $prefix . 'works_link',
                'std'  => '',
                'type'    => 'text',
            ),
    ...
    $meta_boxes[] = array(
        'id'         => 'slider_gallery_metabox',
        'title'      => esc_html__('Slider Options','gardener'),
        'pages'      => array( 'slider_gallery' ), // Post type
        'context'    => 'normal',
        'priority'   => 'high',
        'show_names' => true, // Show field names on the left
        'fields' => array(
            ...
            array(
                'name' => esc_html__('Текст на слайде','gardener'),
                'desc' => esc_html__('Введи текст на слайде','gardener'),
                'id'   => $prefix . 'text_on_slide',
                'std'  => '',
                'type'    => 'textarea',
            ),
        )
