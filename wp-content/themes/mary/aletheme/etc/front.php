...
function ale_enqueue_styles() {
	...
	//Register libs
	wp_register_style( 'font-awesome', ALETHEME_THEME_URL . '/css/fontawesome.min.css', array(), ALETHEME_THEME_VERSION, 'all');
	//wp_register_style( 'popup', 'magnific-popup/magnific-popup.css', array(), ALETHEME_THEME_VERSION, 'all');
	...
	//Load general css
	wp_enqueue_style( 'popup', 'magnific-popup/magnific-popup.css');
...
function ale_enqueue_scripts() {
    ...
    wp_register_script( 'popup', 'magnific-popup/jquery.magnific-popup.js', array( 'jquery' ), ALETHEME_THEME_VERSION, true );
	...
	wp_enqueue_script('popup','https://unpkg.com/swiper/js/swiper.min.js');
